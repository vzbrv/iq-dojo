...
A polished, mobile-first pitch prototype for a crypto-native learning game powered by IQ.wiki content.
...
- No wallet connection or token balance check
- IQ Holder Unlocks are locked placeholders
- Base badge claim and minting are placeholders
- Analytics logs events to the browser console
- IQ.wiki links currently use the IQ.wiki homepage

## Before Base App registration
